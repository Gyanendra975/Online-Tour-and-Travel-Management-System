                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <div class="container" style="margin-bottom: 40px;">
                            ...
                            <form id="packageForm" action="Cabs_add" method="post">
                                <div class="form-group" >
                                    <label for="vehiclename">Vehicle Name</label>
                                    <input type="text" class="form-control" id="packageName" name="vname" placeholder="Enter Vehicle Name" required>
                                </div>
                                <div class="form-group">
                                    <label for="v_no">Vehicle Number</label>
                                    <textarea class="form-control" id="packageDescription" name="vnumber" placeholder="Enter Vehicle Number" rows="1" required></textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-primary" id="addDestination">Add Cab</button>
